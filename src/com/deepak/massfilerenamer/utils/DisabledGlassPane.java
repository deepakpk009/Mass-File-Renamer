/*
 This file is part of MassFileRenamer v0.3
...
/*
 * Author: Rob Camick 
 * Link: http://tips4java.wordpress.com/2008/11/07/disabled-glass-pane/
 */
...
public class DisabledGlassPane extends JComponent
    ...
    public DisabledGlassPane() {
        ...
        setOpaque(false);
        Color base = Color.GRAY;//UIManager.getColor("inactiveCaptionBorder");
